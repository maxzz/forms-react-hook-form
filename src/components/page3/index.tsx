    ...
    return (
        <div className="flex items-center justify-center">
            <div className="self-start  z-10">
                <button className="mx-4 mt-4 px-4 py-2 bg-gray-500/20 border-gray-500/50 border rounded shadow select-none active:scale-y-95" onClick={onClose}>Open</button>
            </div>
